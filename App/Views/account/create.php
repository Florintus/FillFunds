...
<head>
    ...
    <title>Добавить счёт - FillFunds</title>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-500 ml-1 md:ml-2">Добавить счёт</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Добавить счёт</h1>
                    <p class="text-gray-600 mt-1">Создайте новый счёт для управления финансами</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover">
            <form action="/accounts/store" method="post" class="space-y-6">
                <!-- Account Name -->
                <div>
                    ...
                    <input 
                        ...
                        name="name" 
                        required 
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                        placeholder="Например: Основной счёт, Карта Сбербанка"
                    >
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input 
                            ...
                            value="0" 
                            required 
                            class="w-full px-4 py-3 pr-12 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                            placeholder="0.00"
                        >
                    ...
                    <p class="mt-1 text-sm text-gray-500">Укажите текущий баланс счёта</p>
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        name="note" 
                        rows="4"
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors resize-none"
                        placeholder="Дополнительная информация о счёте (необязательно)"
                    ></textarea>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6">
                    <button 
                        type="submit" 
                        class="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
