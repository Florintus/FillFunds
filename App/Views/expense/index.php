...
<head>
    ...
    <title>Список расходов - FillFunds</title>
    ...
    <main class="container">
        ...
        <div class="page-header">
            <div class="page-info">
                ...
                <div>
                    <h1 class="page-title">Список расходов</h1>
                    <p class="page-subtitle">Контроль и учет всех ваших трат</p>
                </div>
            </div>
        ...
        <?php if (empty($expenses)): ?>
            ...
            <div class="card">
                <div class="empty-state">
                    ...
                    <h3 style="font-size: 1.25rem; font-weight: 600; margin-bottom: 0.5rem;">Расходы не найдены</h3>
                    <p style="margin-bottom: 1.5rem;">Начните отслеживать свои расходы для лучшего контроля финансов</p>
                    <a href="/expenses/create" class="btn btn-primary">
                        <svg style="display: inline-block; width: 20px; height: 20px; margin-right: 8px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
        ...
        <?php else: ?>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="font-size: 0.875rem; color: #6b7280;">
                                        <?= date('H:i', strtotime($e['date'])) ?>
                                    </div>
                                </td>
                                <td>
                                    <div style="display: flex; align-items: center;">
                                        <div style="width: 32px; height: 32px; background: #fecaca; border-radius: 0.5rem; display: flex; align-items: center; justify-content: center; margin-right: 0.75rem;">
                                        ...
                                        <div style="font-weight: 500;">
                                            <?= htmlspecialchars($e['account'] ?? 'Не указан') ?>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <?php if (!empty($e['subcategory'])): ?>
                                        <div style="font-size: 0.875rem; color: #6b7280;">
                                            <?= htmlspecialchars($e['subcategory']) ?>
                                        </div>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td style="max-width: 200px;">
                                    <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                        <?= htmlspecialchars($e['description'] ?: 'Без описания') ?>
                                    </div>
                                </td>
                                <td>
                                    <a href="/expenses/edit?id=<?= $e['id'] ?>" class="action-btn edit-btn" title="Редактировать">✏️</a>
                                    <a href="/expenses/delete?id=<?= $e['id'] ?>" class="action-btn delete-btn" onclick="return confirm('Удалить расход?')" title="Удалить">🗑️</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="summary-card">
                <div style="display: flex; align-items: center;">
                    <div style="width: 48px; height: 48px; background: #dc2626; border-radius: 0.5rem; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="font-size: 0.875rem; color: #6b7280;">Контролируйте свои расходы для эффективного управления бюджетом</p>
                    </div>
                </div>
            </div>
        <?php endif; ?>
