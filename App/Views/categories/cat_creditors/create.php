...
<head>
    ...
    <title>Добавить кредитора - FillFunds</title>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-500 ml-1 md:ml-2">Добавить кредитора</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Добавить кредитора</h1>
                    <p class="text-gray-600 mt-1">Создайте нового кредитора для управления задолженностями</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover">
            <form method="post" action="/categories/creditors/store" class="space-y-6">
                <!-- Creditor Name -->
                <div>
        ...
        <div class="mt-6 bg-blue-50 rounded-xl p-6">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Что такое кредитор?</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <p>Кредитор — это физическое или юридическое лицо, которому вы должны деньги. Это может быть:</p>
                        <ul class="mt-2 list-disc list-inside space-y-1">
                            <li>Банки и финансовые учреждения</li>
                            <li>Поставщики товаров и услуг</li>
                            <li>Частные лица</li>
