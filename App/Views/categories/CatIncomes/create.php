...
<head>
    ...
    <title>Добавить категорию доходов - FillFunds</title>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/categories/income" class="text-gray-600 hover:text-blue-600 transition-colors ml-1 md:ml-2">Категории доходов</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Добавить категорию доходов</h1>
                    <p class="text-gray-600 mt-1">Создайте новую категорию для классификации доходов</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover">
            <form method="post" action="/categories/income/store" class="space-y-6">
                <!-- Category Name -->
                <div>
                    ...
                    <input 
                        ...
                        name="name" 
                        required 
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors"
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        name="description" 
                        rows="4"
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors resize-none"
                        placeholder="Дополнительная информация о категории (необязательно)"
                    ></textarea>
                    <p class="mt-1 text-sm text-gray-500">Опишите, какие виды доходов относятся к этой категории</p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6">
                    <button 
                        type="submit" 
                        class="flex-1 px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
        ...
        <div class="mt-6 bg-green-50 rounded-xl p-6">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-green-800">Примеры категорий доходов</h3>
                    <div class="mt-2 text-sm text-green-700">
                        <p>Популярные категории, которые можно создать:</p>
                        <ul class="mt-2 list-disc list-inside space-y-1">
                            <li>Зарплата — основной доход от работы</li>
                            <li>Фриланс — доходы от внештатной деятельности</li>
                            <li>Инвестиции — прибыль от инвестиционной деятельности</li>
                            <li>Пассивный доход — доходы от аренды, дивидендов</li>
                            <li>Подарки — денежные подарки и премии</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- Back Link -->
        <div class="mt-8">
            <a href="/categories/income" class="inline-flex items-center text-gray-600 hover:text-blue-600 transition-colors">
