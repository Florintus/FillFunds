...
<head>
    ...
    <title>Категории расходов - FillFunds</title>
...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-500 ml-1 md:ml-2">Категории расходов</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div class="flex items-center space-x-3 mb-4 md:mb-0">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Категории расходов</h1>
                    <p class="text-gray-600 mt-1">Управление категориями расходов для точного учета</p>
                </div>
            </div>
            
            <!-- Add Category Button -->
            <a 
                href="/categories/expenses/create" 
        ...
        <?php if (empty($categories)): ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-12 text-center card-hover">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-3">Нет категорий расходов</h3>
                <p class="text-gray-600 mb-6 max-w-md mx-auto">Начните с создания первой категории для классификации ваших расходов</p>
                <a 
                    href="/categories/expenses/create" 
        ...
        <?php else: ?>
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Категория расходов</p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-2">
                                <button 
            ...
            <div class="mt-8 bg-gradient-to-br from-red-50 to-pink-50 rounded-xl p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-lg font-semibold text-gray-900">Всего категорий расходов: <?= count($categories) ?></p>
                        <p class="text-sm text-gray-600">Контролируйте и классифицируйте все ваши расходы для лучшего финансового планирования</p>
                    </div>
                </div>
            </div>
        <?php endif; ?>
    ...
    <script type="module">
        ...
        window.editCategory = function(id) {
            window.location.href = `/categories/expenses/edit?id=${id}`;
        };
        ...
        deleteConfirm.addEventListener('click', function() {
            if (categoryToDelete) {
                ...
                form.method = 'POST';
                form.action = '/categories/expenses/delete';
