...
<head>
    ...
    <title>Редактировать категорию расходов - FillFunds</title>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Редактировать категорию расходов</h1>
                    <p class="text-gray-600 mt-1">Измените информацию о категории расходов</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover">
            <form method="post" action="/categories/expenses/update" class="space-y-6">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        <p>Изменение названия категории расходов может повлиять на связанные с ней транзакции и отчеты. Убедитесь, что новое название корректно отражает тип расходов.</p>
                    </div>
                </div>
            </div>
        </div>
