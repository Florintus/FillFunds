...
<head>
    ...
    <title>Редактировать кредитора - FillFunds</title>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/categories/creditors" class="text-gray-600 hover:text-blue-600 transition-colors ml-1 md:ml-2">Кредиторы</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Редактировать кредитора</h1>
                    <p class="text-gray-600 mt-1">Измените информацию о кредиторе</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover">
            <form method="post" action="/categories/creditors/update" class="space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        required 
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-colors"
                        placeholder="Например: Банк ВТБ, ООО 'Поставщик', Иван Иванов"
                    >
                    <p class="mt-1 text-sm text-gray-500">Укажите наименование организации или ФИО физического лица</p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6">
                    <button 
                        type="submit" 
                        class="flex-1 px-6 py-3 bg-gradient-to-r from-orange-600 to-red-600 text-white font-medium rounded-xl hover:from-orange-700 hover:to-red-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        <p>Изменение имени кредитора может повлиять на связанные с ним транзакции и отчеты. Убедитесь, что новое название корректно.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Back Link -->
        <div class="mt-8">
            <a href="/categories/creditors" class="inline-flex items-center text-gray-600 hover:text-blue-600 transition-colors">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                </svg>
                Вернуться к списку кредиторов
            </a>
        </div>
    </main>
