...
<head>
    ...
    <title>Редактировать расход - FillFunds</title>
...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex">
                    <ol class="flex items-center space-x-2 text-sm">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-900 font-medium">Редактировать расход</li>
                    </ol>
                </nav>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl font-bold text-gray-900 mb-4">Редактировать расход</h1>
            <p class="text-lg text-gray-600">Внесите изменения в существующий расход</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover">
            <form action="/edit" method="post" class="space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6">
                    <button 
                        type="submit" 
                        class="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                    >
        ...
        <!-- Quick Actions -->
        <div class="mt-12">
            <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center">Связанные действия</h2>
            <div class="grid md:grid-cols-3 gap-6">
                <a href="/expenses" class="bg-white p-6 rounded-xl shadow-lg card-hover text-center">
                    ...
                    <p class="text-sm text-gray-600">Просмотреть все расходы</p>
                </a>

                <a href="/add" class="bg-white p-6 rounded-xl shadow-lg card-hover text-center">
                    <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                        <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </div>
                    <h3 class="font-semibold text-gray-900 mb-2">Добавить расход</h3>
                    <p class="text-sm text-gray-600">Создать новый расход</p>
                </a>

                <a href="/logs" class="bg-white p-6 rounded-xl shadow-lg card-hover text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 mb-2">История изменений</h3>
                    <p class="text-sm text-gray-600">Посмотреть журнал операций</p>
                </a>
            </div>
        </div>
    </main>
    ...
    <script type="module">
        ...
        form.addEventListener('submit', function(e) {
            ...
            submitButton.innerHTML = '<svg class="w-5 h-5 inline mr-2 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>Сохранение...';
        });
